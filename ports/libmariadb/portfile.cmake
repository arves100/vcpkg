...
list(FIND FEATURE_OPTIONS "-DWITH_SSL=ON" WITH_SSL_INDEX)
if(NOT ${WITH_SSL_INDEX} EQUAL -1)
    list(REMOVE_AT FEATURE_OPTIONS WITH_SSL_INDEX)	
    list(APPEND FEATURE_OPTIONS "-DWITH_SSL=OPENSSL")
endif()
